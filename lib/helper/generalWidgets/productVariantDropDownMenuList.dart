      ...
      builder: (context, selectedVariantItemProvider, _) {
        return widget.variants.isNotEmpty
            ? Column(
                ...
                children: [
                  if (widget.variants.first.fewQuantityLeft!) ...[
                    Padding(
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.only(end: 30, start: 5),
                    child: CustomTextLabel(
                  ...
                  if (widget.product.productRating!)
                    getSizedBox(height: 5),
                  if (widget.product.productRating!)
                                                      ...
                                                      child: Column(
                                                        crossAxisAlignment:
                                                            CrossAxisAlignment
                                                                .start,
                                                        children: [
                                                          if (widget.variants[index].fewQuantityLeft!)
                                                            Padding(
