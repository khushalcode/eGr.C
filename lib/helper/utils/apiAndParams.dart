class ApiAndParams {
  ...
  static String apiBlogCategories = 'blog_categories';
  static String apiBlogs = 'blogs';
  static String apiUserProductRequests = 'user_product_requests';
  static String apiUserProductRequestsList = '$apiUserProductRequests/list';
  static String apiUserProductRequestAdd = '$apiUserProductRequests/add';
  static String apiRecentlyVisited = 'products/recently_visited';
  static String apiAddRecentlyVisitedProduct = 'sections/add_recently_visited_product';
  static String apiSubscriptionPlans = 'subscription_plans';
  static String apiSubscriptionFaqs = 'subscription_faqs';
  static String apiUserActivePlan = 'user_active_plan';
...
//general
  ...
  static String subscriptionPlanId = "subscription_plan_id";
...
//category
  ...
  static String subscriptionType = "subscription";
  ...
  static String isFreeDelivery = "is_free_delivery";
