...
class LocalAwesomeNotification {
  ...
  init(BuildContext context) async {
    if (notification != null && messagingInstance != null && localNotification != null) {
      disposeListeners().then((value) async {
        ...
        await notification?.initialize(
          ...
          channelGroups: [NotificationChannelGroup(channelGroupKey: "Basic notifications", channelGroupName: 'Basic notifications')],
          debug: kDebugMode,
        );
  ...
  static registerListeners(context) async {
    try {
      ...
      messagingInstance?.setForegroundNotificationPresentationOptions(alert: true, badge: true, sound: true);
