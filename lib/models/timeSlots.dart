...
class TimeSlotsData {
  ...
  late final String timeSlotSetting;
  ...
  TimeSlotsData.fromJson(Map<String, dynamic> json) {
    ...
    timeSlots = List.from(json['time_slots'])
        ...
        .toList();
    timeSlotSetting = json['time_slot_setting']?? "false";
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    itemData['time_slot_setting'] = timeSlotSetting;
    return itemData;
  }
}
...
class TimeSlots {
  ...
  TimeSlots.fromJson(Map<String, dynamic> json) {
    ...
    status = json['status'].toString();
    isFreeDelivery = (json['is_free_delivery']??0).toString();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    itemData['status'] = status;
    itemData['is_free_delivery'] = isFreeDelivery;
    return itemData;
  }
}
