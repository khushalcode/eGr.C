...
class AppSettingsProvider extends ChangeNotifier {
  ...
  Future getAppSettingsProvider(BuildContext context) async {
    ...
    try {
      ...
      debugPrint("API Error in getAppSettingsProvider: $e");
      message = e.toString();
      ...
      try {
        ...
        if (context.mounted) {
          ...
          context.read<LanguageProvider>().currentLocalOfflineLanguage = localLanguage;
          debugPrint("Local language loaded for error screen. Keys count: ${localLanguage.length}");
        }
      } catch (localError) {
        debugPrint("Failed to load local language for error screen: $localError");
      }
