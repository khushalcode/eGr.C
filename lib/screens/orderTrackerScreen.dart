...
class _OrderTrackerScreenState extends State<OrderTrackerScreen> {
  ...
  /* Future<List<LatLng>> getRoutePoints(LatLng origin, LatLng destination) async {
    final url =
        'https://maps.googleapis.com/maps/api/directions/json?origin=${origin.latitude},${origin.longitude}&destination=${destination.latitude},${destination.longitude}&key=${Platform.isAndroid?Constant.androidApiKey: Constant.iOSApiKey}';
