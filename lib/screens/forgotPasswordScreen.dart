...
class _ForgotPasswordState extends State<ForgotPasswordScreen> {
  ...
  firebaseLoginProcess() async {
    ...
    if (editMobileTextEditingController.text.isNotEmpty) {
        // [iPad crash fix] Guard selectedCountryCode null assertion (CountryCodePicker.onInit may not have fired)
          ...
          try {
            await firebaseAuth.verifyPhoneNumber(
              ...
              verificationFailed: (FirebaseAuthException e) {
                showMessage(
                  context,
                  // [iPad crash fix] null-safe error message
            ...
            // [iPad crash fix] Catch unexpected Firebase / platform exceptions
            if (mounted) {
              setState(() {
                isLoading = false;
              });
